...
struct WeeklyCheckInView: View {
    ...
    private var volumeComparisonCard: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            HStack(spacing: 16) {
                volumeBar(label: L10n.tr("Last Week"), value: review.summary.previousWeekVolume, maxValue: max(review.summary.totalVolume, review.summary.previousWeekVolume), color: .white.opacity(0.2))
                volumeBar(label: L10n.tr("This Week"), value: review.summary.totalVolume, maxValue: max(review.summary.totalVolume, review.summary.previousWeekVolume), color: STRQBrand.steel)
            }
            .frame(height: 80)
        }
        .padding(16)
